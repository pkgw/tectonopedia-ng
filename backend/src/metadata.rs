    ...
    pub fn parse(s: &'a str) -> Result<Self> {
        ...
        match cseq {
            "output" => {
                    ...
                    terms.len() == 1,
                    "malformed metadata line {:?}: \\output must be followed by exactly 1 braced term",
                    s
                );
            ...
            "idef" => {
                    ...
                    terms.len() == 3,
                    "malformed metadata line {:?}: \\idef must be followed by exactly 3 braced terms",
                    s
                );
            ...
            "iref" => {
                    ...
                    terms.len() == 3,
                    "malformed metadata line {:?}: \\iref must be followed by exactly 3 braced terms",
                    s
                );
            ...
            "itext" => {
                    ...
                    terms.len() == 4,
                    "malformed metadata line {:?}: \\itext must be followed by exactly 4 braced terms",
                    s
                );
